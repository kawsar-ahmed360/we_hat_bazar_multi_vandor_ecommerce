    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h2 style="font-family: monospace;font-weight: normal;">Page Create:</h2>

                <form action="{{ route('UserPageStore') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row gutters">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="imgInp" placeholder="Enter  title">
                                @error('title')
