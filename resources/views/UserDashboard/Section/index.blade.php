...
@section('user-content')
    ...
    <div class="table-container">
        <div class="t-header">All Section  <a href="{{route('UserSectionCreate')}}"><span style="float: right;cursor:pointer" class="btn btn-success btn-sm">Add Section</span></a></div>
                ...
                @foreach($index as $key=>$sec)
                    <tr class="odd gradeX">
                        ...
                        <td style="text-align: center;">
                            ...
                            <a href="{{route('UserSectionEdite',$sec->id)}}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Edit</a>
                            <a  href="{{route('UserSectionDelete',$sec->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</a>
