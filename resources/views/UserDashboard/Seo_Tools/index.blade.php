        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('UserSeoToolsHomeEdite')}}" method="POST">
                        @csrf
                    <div class="row">
                        <div class="col-md-12">
    ...
    <div class="modal" id="ShopSeo">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="modal-body">
                    <form action="{{route('UserSeoToolsShopEdite')}}" method="POST">
                        @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <label for="">Meta Title</label>
    ...
    <div class="modal" id="ContactSeo">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="modal-body">
                    <form action="{{route('UserSeoToolsContactEdite')}}" method="POST">
                        @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <label for="">Meta Title</label>
