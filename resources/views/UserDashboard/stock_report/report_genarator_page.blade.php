...
@section('title') Stock Report Genarate Page @endsection
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="category_wise" style="display: none">
                                          ...
                                          <form action="{{ route('UserCategoryWiseStock') }}" method="POST">
                                            @csrf
                                        ...
                                        <div class="product_wise" style="display: none">
                                          ...
                                          <form action="{{ route('UserProductWiseStockGenare') }}" method="POST">
                                            @csrf
...
<script type="text/javascript">
  $(document).on('change','#cate_wise_report',function(){
    ...
    $.ajax({
      url:"{{ route('UserStockGenaratorProductAjax') }}",
      type:"GET",
      data:{cat_id:cat_id},
