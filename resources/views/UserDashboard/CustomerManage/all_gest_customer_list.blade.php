                ...
                @foreach($index as $key=>$index)
                    <tr class="odd gradeX">
                        ...
                        <td style="text-align: center;">
                            ...
                            <a  href="{{route('UserGestCustomerView',$index->id)}}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i> View</a>
                            <a  href="{{route('UserGestCustomerDelete',$index->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</a>
