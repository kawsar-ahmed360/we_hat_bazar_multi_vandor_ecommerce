                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="@if(@$edite){{ route('UserCouponUpdate') }} @else{{ route('UserCouponStore') }}@endif" method="POST" enctype="multipart/form-data">
                                    @csrf
                        ...
                        @foreach($index as $key=>$index)
                            <tr class="odd gradeX">
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <a href="{{route('UserCouponEdite',$index->id)}}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                    <a  href="{{route('UserCouponDelete',$index->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</a>
