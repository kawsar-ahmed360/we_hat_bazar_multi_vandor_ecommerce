                    ...
                    <div class="account-settings">
                        <div class="user-profile">
                            <div class="user-avatar">
                                <img src="{{(@$info->profile)?url('upload/Admin/Profile/'.$info->profile):asset('backend/img/user.png')}}" alt="Le Rouge Admin" />
                            </div>
        ...
        <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
            <div class="card h-100">
                ...
                <form action="{{route('SettingUpdate')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" value="{{Auth::user('admin')->id}}" name="EditeId">
                <div class="card-body">
                    <div class="row gutters">
                        ...
                        @if(@$info->profile)
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <img style="width: 100px;" src="{{(@$info->profile)?url('upload/Admin/Profile/'.$info->profile):''}}" alt="your image" />
                                </div>
                            </div>
