...
@section('admin-content')
    ...
    <div class="table-container">
        <div class="t-header">All Customer List <a href="#" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#myModal">Mail Text</a></div>
                ...
                @foreach($index as $key=>$index)
                    <tr class="odd gradeX">
                        ...
                        <td style="text-align: center;">
                            ...
                            <a  href="{{route('CustomerView',$index->id)}}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i> View</a>
                            <a  href="{{route('CustomerDelete',$index->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</a>
            ...
            $('#clicks').on('click', function (e) {
               ...
               var textmail= $('#mailtext').val();
                ...
                $.ajax({
                    ...
                    url: '{{route("MultipleCustomerSendMail")}}',
