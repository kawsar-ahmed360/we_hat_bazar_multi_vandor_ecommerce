    ...
    <div class="table-container">
        ...
        <div class="">
            ...
            <div class="row gutters">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 table-responsive">



                    <table id="copy-print-csv" class="table custom-table table-responsive" style="overflow-x:auto">
                        <thead>
                        <tr>
                            <th>SL.</th>
                            <th>Phone</th>
